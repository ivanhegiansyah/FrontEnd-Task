...
export default function Form() {
  ...
  const validateOnChange = (name, value) => {
    if (name === "nama" && !regexName.test(value)) {
      setErrorMessage({
        ...errorMessage,
        nama: "Full name can't contain number",
      });
      ...
      <form onSubmit={onSubmit}>
        <div className="pb-3">
          ...
          <input
            ...
            onChange={onChange}
          />
          <span style={{ color: "red" }}>{errorMessage.nama}</span>
        </div>
        <div className="pb-3">
        ...
        <div className="pb-3">
          ...
          <input
            ...
            onChange={onChange}
          />
          <span style={{ color: "red" }}>{errorMessage.phone}</span>
        </div>
        <div className="pb-3">
          ...
          <span style={{ color: "red" }}>{errorMessage.nationality}</span>
        </div>
        <div className="pb-3">
